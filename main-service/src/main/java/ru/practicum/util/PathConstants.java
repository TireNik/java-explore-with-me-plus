...
public class PathConstants {
    ...
    public static final String PRIVATE_EVENTS = USERS + USER_ID + EVENTS; // Базовый путь для приватных событий пользователя
    ...
    public static final String PRIVATE_REQUESTS = USERS + USER_ID + REQUESTS; // Все запросы пользователя
